...
?>
    ...
    <div style="background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQReDKUNzhvqwnpmJJBJpjuN0tGaQfxY2C2Xg&usqp=CAU); height:640px;">
        ...
        <div class="card-body card-block">
            <form method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport" action="specdate/acadspec.php">
                ...
                <div class="row form-group">
                    <div class="col col-md-3" style="font-size:30px;  font-style:times new roman;">
