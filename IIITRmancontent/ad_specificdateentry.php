            ...
            <div class="fluid-container" style="background-color:white;">
                <div class="row">
                    <div class="col-12 col-lg-4 left-bar pt-3" style="background-color:white;">
                        ...
                        <a href="hostel.php"><button class="button2 button" style="width:80%;">Hostel</button></a><br>
                        <a href="acadblockspdate.php"><button class="button2 button" style="width:80%;">Academic Block</button></a><br>
                        <a href="sportspecdate.php"><button class="button2 button" style="width:80%;">Sports records</button></a><br>
                        <a href="libraryspecdate.php"><button class="button2 button" style="width:80%;">Library</button></a><br>
                    </div>
                    <?php
