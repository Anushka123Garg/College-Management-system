...
?>
    ...
    <body>
        ...
        <div class="statbox" style="background-color:white;">
            <div class="fluid-container" style="background-color:white;">
                <div class="row">
                    <div class="col-12 col-lg-4 left-bar pt-3" style="background-color:white;">
                        <a href="adhomepage.php"><button class="button2 button" style="width:80%;">Home Page</button></a><br>
                        <a href="newentry/hostelentry.php"><button class="button2 button" style="width:80%;">Hostel</button></a><br>
                        <a href="newentry/acadblockentry.php"><button class="button2 button" style="width:80%;">Academic Block</button></a><br>
                        <a href="newentry/sportsentry.php"><button class="button2 button" style="width:80%;">Sports records</button></a><br>
                        <a href="newentry/libraryentry.php"><button class="button2 button" style="width:80%;">Library</button></a><br>
                    </div>
                    <?php
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="visitor-card text-center card1" style="background-color:lightsalmon;">
                            <h4>Hostel entries till now</h4>
                            <h1 class="count"><?php echo $count_hostelentries ?></h1>
                        </div>
                        <div class="visitor-card text-center" style="background-color:lightsalmon;">
