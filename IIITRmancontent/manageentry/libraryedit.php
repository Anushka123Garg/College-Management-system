...
?>
  ...
  <body>
    <?php
    $id = $_GET['editid'];
    $ret = mysqli_query($con, "select * from  libraryentry where id='$id'");
    $cnt = 1;
    ...
    if (isset($_POST['submit'])) {
      $remark = $_POST['remark'];
      $query = mysqli_query($con, "update libraryentry set remarks='$remark' where  id='$id'");
      $query = mysqli_query($con, "update libraryentry set returndate=current_timestamp() where  id='$id'");
