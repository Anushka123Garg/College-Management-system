...
?>
    ...
    <body>
                                ...
                                <div class="table">
                                    ...
                                    <h1 style="text-align:center;"><u>Acad Block Entries </u></h1>
                                        <thead>
                                        ...
                                        <?php
                                        $ret = mysqli_query($con, "select * from acadblockentry where rollno='$roll' order by date");
                                        $cnt = 1;
