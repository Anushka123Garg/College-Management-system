...
<body>
    ...
    <form class="" name="search" action="searchacadblock.php" method="post">
        <input class="search-form" type="text" name="search-data" id="searchdata" placeholder="Search by name or roll number" style="font-size:30px; padding:20px; width:500px; background-color:black; color:white;"/>
