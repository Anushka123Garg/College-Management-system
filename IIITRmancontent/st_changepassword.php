<!-- UPDATE `stlogin` SET `Password` = 'sani' WHERE `stlogin`.`ID` = 51;  -->
<?php
session_start();
error_reporting(0);
$host = "localhost";
...
?>
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($oldpassword == $password) {
            if ($newpassword == $confirmpassword) {
                $change = mysqli_query($con, " UPDATE `stlogin` SET `Password` = '$newpassword' WHERE `stlogin`.`ID`= '$stid'");
    ...
    height:100vh; background-image:url(https://media.istockphoto.com/photos/blue-brush-strokes-in-horizontal-background-picture-id471620647?b=1&k=20&m=471620647&s=170667a&w=0&h=6r36Xmec_igdAVtL6l41D-miBTkdA2S_ZttFMVMk0Fk=); ">
...
">
                <div class="">
                    ...
                    <p style="font-size:25px ;color:blue; font-family:sans-serif;"> <b>Change Password</b></p>
                    ...
                    <button class="button" type="Submit" style="width:200px; height:50px; font-size:20px; background-color:black; color:white;font-weight:bold; border-radius:40px;" name="Submit">Submit</button>
