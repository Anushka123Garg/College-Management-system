...
?>
    ...
    <body>
                    ...
                    <div class="d-flex flex-row ">
                        <div>
                            ...
                            <a href="logout.php" transition:background-color:white 400ms linear ease-in;>
                                <button class="logout" name="logout" style="background-color:black;color:white;width:100px;height:40px;border-radius:5px;margin-bottom:10px; margin-left:600px;  margin-top:30px;" href='logout.php'>LOG OUT</button>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div style="background-color:white;">
            <div class="fluid-container">
                <div class="row">
                    <div class="col-12 col-lg-4 side-bar" style="background-color:white; margin-top:16px;">
                        <a href="sthomepage.php"><button class="button2" style="width:80%;">Home page</button></a><br>
                        <a href="student\hostel.php"><button class="button2" style="width:80%;">Hostel Entry</button></a>
                        <a href="student\sports.php"><button class="button2" style="width:80%;">Sports Entry</button></a>
                        <a href="student\acad.php"><button class="button2" style="width:80%;">Acad Block Entry</button></a>
                        <a href="student\library.php"><button class="button2" style="width:80%;">Library Entry</button></a>
                    </div>
                    <?php
