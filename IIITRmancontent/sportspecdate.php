    ...
    <div style="background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQReDKUNzhvqwnpmJJBJpjuN0tGaQfxY2C2Xg&usqp=CAU); height:640px;">
        ...
        <u><i>Click here to go to home page</i></u>
            ...
            <div class="card-body card-block">
                <form method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport" action="specdate/sportspec.php">
            ...
            <div class="text-center copyright-section" style="margin-top:280px; color:white;">
